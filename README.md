...
<h3>Jump</h3>  
    If a player's piece lands on a tile with the same color, their piece will jump to the next tile of that color. There are no jumps in the final approach stage.  

<h3>Flight</h3>
    If a player's piece lands on their color's flight tile (the tile that has arrows pointing across the board), their piece can take a shortcut and fly to the other side of the flight path.  
